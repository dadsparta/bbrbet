    ...
    return Container(
      ...
      child: ListView(
        ...
        children: [
          ...
          AppTexts.lastResult(widget.resultOfExpress),
          SizedBox(
            height: 5,
          ),
          Row(
            children: [
              Expanded(
                child: Container(
                  ...
                  child: AppTexts.smallRes(
                      'Total AM: ' + widget.totalAM, Colors.white),
                ),
              ),
              SizedBox(
                width: 8,
              ...
              Expanded(
                child: Container(
                  ...
                  child: AppTexts.smallRes(
                      '% of Bank: ' + widget.percentage, Colors.white),
                ),
              ),
            ],
          ),
